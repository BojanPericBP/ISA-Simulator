...
namespace SimulatorISA
{
    public partial class Form1 : Form
    {
        ...
        Regex reg = new Regex(@"^((\*|(((add|sub|and|or|cmp|je|cmp) (r[1-4]|srb|srd|#?[0-9]|-?[0-9]{1,17}), (r[1-4]|srb|srd|#?[0-9]|-?[0-9]{1,17}))|not (r[1-4]|srb|srd|#?[0-9]|-?[0-9]{1,17})|mov (r[1-4]|srb|srd|#[0-9]), (r[1-4]|srb|srd|#?[0-9]|-?[0-9]{1,17})))|((je |jge |jl )?labela[1-9][0-9]?:))$", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        public void interpretiraj()
        {
            ...
            else
            {
                ...
                {
                    if (!jednaInstrukcija.Contains(':') && !jednaInstrukcija.Contains('*'))
